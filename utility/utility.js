...
module.exports.emailTemplateOTP = (name, otp, link) => {
  ...
  <div style="background-color: rgb(55, 71, 79); width: 600px; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); text-align: center; margin: 1rem auto;">
...
module.exports.emailTemplateResetPassword = (name, link) => {
  return `<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0; display: flex; justify-content: center; align-items: center; height: 100vh; width: 100%;">
  <div style="background-color: #ffffff; width: 600px; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); text-align: center;margin: 1rem auto">
    <div style="border-bottom: 1px solid #eeeeee; padding-bottom: 10px; margin-bottom: 20px;">
      <h1 style="margin: 0; font-size: 24px; color: #333333;">Verify Your Email Address</h1>
    </div>
    <div style="font-size: 16px; color: #555555; text-align: left;">
      <p style="margin: 10px 0;">Dear ${name},</p>
      <p style="margin: 10px 0;">
        Thank you for registering with us. Please visit the link below to
        verify your email address by entering the OTP provided:
      ...
      <div style="display: flex; flex-direction: column; align-items: center;">
        <a href="${link}" style="display: inline-block; margin: 20px 0; padding: 10px 20px; font-size: 16px; color: #ffffff; background-color: #007bff; border-radius: 5px; text-decoration: none;">Go to Verification Page</a>
      </div>
      <p style="margin: 10px 0;">Best Regards,</p>
      <p style="margin: 10px 0;">EnergiSpeak Analytics Pvt. Ltd.</p>
    </div>
    <div style="border-top: 1px solid #eeeeee; padding-top: 10px; margin-top: 20px; font-size: 12px; color: #999999;">
      <p>&copy; 2024 EnergiSpeak Analytics Pvt. Ltd. All rights reserved.</p>
    </div>
  </div>
</body>`;
};
